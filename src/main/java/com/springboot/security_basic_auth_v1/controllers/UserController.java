package com.springboot.security_basic_auth_v1.controllers;
...
import com.springboot.security_basic_auth_v1.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<Object> loginUser(@RequestBody @Valid LoginUserRequestDto loginUserRequestDto){
        userService.loginUser(loginUserRequestDto);
        return new ResponseEntity<>("User Logged successfully!",HttpStatus.CREATED);
    }
