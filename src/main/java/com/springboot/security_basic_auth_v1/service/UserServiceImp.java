...
import com.springboot.security_basic_auth_v1.exceptions.InvalidRoleIdsException;
import com.springboot.security_basic_auth_v1.exceptions.UserNotFoundException;
import com.springboot.security_basic_auth_v1.exceptions.UsernameExistsException;
import com.springboot.security_basic_auth_v1.mappers.UserMapper;
import com.springboot.security_basic_auth_v1.models.Role;
...
public class UserServiceImp implements UserService {
    ...
    @Autowired
    public UserServiceImp(UserRepository userRepository, UserMapper userMapper, RoleService roleService, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager) {
    ...
    @Override
    @Transactional
    public void loginUser(LoginUserRequestDto longinUserRequestDto) {
        UserEntity user= userMapper.toUser(longinUserRequestDto);
